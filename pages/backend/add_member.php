<form method="post" role="form" enctype="multipart/form-data">
    <div id="tabs">
        ...
        foreach ($parametrs["language"] as $value) {
            ...
            <div id="tabs-<?= $value["id"] ?>">
                ...
                <div class="form-group">
                    <label for="InputTitle"><?= $lang->l("Договор о членстве (название)")?></label>
                    <input type="text" name="contract[<?= $value["id"] ?>]" value="<?= isset($member_desc["contract"])?$member_desc["contract"]:'' ?>" class="form-control">
                </div>
                <div class="form-group">
                    <label for="InputTitle"><?= $lang->l("Договор о членстве (файл)")?></label>
    ...
    <div class="form-group">
        <label for="InputTitle"><?= $lang->l("Партнер")?></label>
